...
### 🍋‍🟩 박상민
처음 프로젝트를 다같이 기획할 때 너무 많은 양의 기능을 소화해보고자 하는 욕심이 많았다고 생각이 들었습니다.
...
약 2달동안 팀 프로젝트를 진행하면서 스스로 실력이 많이 늘었다라는 자신감에 코딩하는 게 행복할 때도 있었고, 고민도 많이 했지만 역시 웹 개발자는 보여지는 화면을 봤을 때 그 희열이 배가 된다고 생각이 듭니다.
너무나도 믿음직스럽고 실력좋은 팀원들을 만나 감사했고 좋은 퀄리티의 사이트를 제작하느라 모두 고생하셨습니다!!
